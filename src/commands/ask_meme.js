...
module.exports = {
  data: new SlashCommandBuilder()
    .setName('ask_meme')
    .setDescription('Create memecoins and get Meme.cooking stats or info about specific memecoins.')
  ...
  async execute(interaction) {
    ...
    try {
      ...
      const agentId = 'meme-cooking-bitte-agent.vercel.app';
