...
module.exports = {
  data: new SlashCommandBuilder()
    .setName('ask_risk')
    .setDescription('AI-powered risk analysis for smart contracts, liquidity pools, and DeFi protocols')
    .addStringOption(option =>
      option.setName('prompt')
        .setDescription('Your question about risk analysis')
        .setRequired(true)
    )
  ...
  async execute(interaction) {
    ...
    try {
      ...
      const agentId = 'risk-analyzer-ai-agent.vercel.app';
